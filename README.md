# `ripgrep_jll.jl` (v15.2.0+0)

[![deps](https://juliahub.com/docs/ripgrep_jll/deps.svg)](https://juliahub.com/ui/Packages/General/ripgrep_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/965d1a731ddbff280bf93d8d6cb49e6abc90c89b/R/ripgrep/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/BurntSushi/ripgrep (revision: `e89fff89ac9af12e8d4ce9d5fd07beb408ca730f`)
